...
export default function PropertyDetails() {
  ...
  const displayDesc =
    expended || !isLongDesc
      ...
      : property.description?.slice(0, 15) + "...";
  return (
        ...
        >
          <View className="flex-row gap-2 mb-3 flex-wrap">
            <View className="bg-blue-50 px-3 py-1 rounded-full">
              <Text className="tex-blue-600 text-xs font-semibold capitalize">
                {property.type}
              </Text>
            </View>
          ...
          {isLongDesc && (
            <TouchableOpacity onPress={() => setExpended(!expended)}>
            ...
            <View className="flex-row gap-3">
              {!property.is_sold && (
                <TouchableOpacity
                  ...
                  className="flex-1 flex-row items-center justify-center gap-2 bg-amber-50 py-4 rounded-2xl border border-amber-200 mb-4"
                >
                  <Ionicons
              ...
              <TouchableOpacity
                ...
                className="flex-1 flex-row items-center justify-center gap-2 bg-red-50 py-4 rounded-2xl border border-red-200 mb-4"
              >
